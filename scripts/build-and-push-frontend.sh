...
# 构建并推送多架构 frontend 镜像到 Docker Hub
# 用法：bash scripts/build-and-push-frontend.sh

set -e

IMAGE=oliviaaa77/babelnet-frontend
CONTEXT=.
...
echo "Multi-arch frontend image build, push, and cleanup complete!" 